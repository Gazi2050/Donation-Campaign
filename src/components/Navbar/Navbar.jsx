...
const Navbar = () => {
    ...
    return (
        <nav className="relative bg-white dark:bg-gray-800 md:px-9 lg:px-9 ">
            <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
                <div className="flex items-center justify-between">
                    <div>
                        <img className="w-auto h-6 sm:h-7" src="/Logo.png" />
                    </div>
                ...
                <div className={`absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center ${isOpen ? 'block' : 'hidden'}`}>
                    <div className="flex flex-col md:flex-row md:mx-6">
                        ...
                        <NavLink to="/Donation" className="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-[#FF444A] dark:hover:text-[#FF444A]
                        focus:underline focus:text-[#FF444A] hover:underline md:mx-4 md:my-0" href="#">Donation</NavLink>
                        <NavLink to="/Statistics" className="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-[#FF444A] dark:hover:text-[#FF444A] focus:underline focus:text-[#FF444A]
                        hover:underline md:mx-4 md:my-0" href="#">Statistics</NavLink>
